...
from neurotools_partial.spatial.dct   import dct_upsample,dct_cut_antialias
from neurotools_partial.signal.signal import rewrap
...
def array_wavelength_pgd_threshold(frame,thresh=0.5):
    ...
    We can further reduce noise by restricting
